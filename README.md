...
- **Document Export**: jsPDF, jsPDF-AutoTable (PDF 출력), XLSX (Excel 스프레드시트 출력)
...
|
 10점 
|
 MediaPipe로 추출된 정면 청중 응시 프레임 비율 
|
|
|
 🤸 자세 & 제스처 
...
|
 10점 
|
 Praat-Parselmouth 기반 주파수 및 데시벨 분포 변동 계수 
|
|
|
 🧘 스피치 평정심 
...
|
 10점 
|
 분당 말버릇 감지 수 (3회 이하 만점, 5회 이상 급격 감점) 
|
|
**
내용 (Content - 50점)
...
|
 15점 
|
 음성 발화 텍스트와 슬라이드 장표 텍스트 의미적 유사도 
|
|
|
 📢 발화 완성도 
